...
<head>
    <meta charset="UTF-8">
    <title>Ingredientes - PratoCerto</title>
...
<body>
    ...
    <div class="container">
        ...
        <a href="{{ route('ingredientes.create') }}" class="btn">
            ...
            <tbody>
                @forelse ($ingredientes as $ingrediente)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('ingredientes.edit', $ingrediente->id) }}" class="btn btn-secondary">
                                Editar
                            </a>
                            ...
                            <form action="{{ route('ingredientes.destroy', $ingrediente->id) }}" method="POST" style="display: inline;">
                                ...
                                <button type="submit" class="btn btn-danger" onclick="return confirm('Tem certeza que deseja excluir este ingrediente?')">
                                    Excluir
                                </button>
                            </form>
                        </td>
